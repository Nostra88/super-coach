...
function getSystemPrompt() {
  return [
    ...
    'If sport is not specified and multiple sports are possible → do NOT guess.',
    'Ask for clarification via: {"matches":[],"summary":"Please specify the sport (Football, Basketball, Tennis, etc.) for this query.","roi_potential":""}',
    '',
