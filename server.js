...
// Cascade de modèles — fallback automatique si le primaire est saturé
// Modèles vérifiés disponibles sur API v1beta en 2026
const MODELS = [
  'gemini-2.5-flash',        // Primaire — meilleure qualité
  'gemini-2.5-flash-lite',   // Fallback 1 — plus léger, même génération
  'gemini-2.0-flash',        // Fallback 2
  'gemini-2.0-flash-lite',   // Fallback 3 — version lite stable
];
  ...
  try {
    ...
    for (const model of MODELS) {
      try {
        ...
        console.log(`[FALLBACK] ${model} erreur réseau → ${err.message}`);
